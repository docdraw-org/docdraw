...
$md[] = "The conformance bundle is the canonical fixture set used to verify conformance to **DocDraw v1** and related profiles (including **DD-PDF-1**).";
$md[] = "";
...
$md[] = "- `examples/source/**`";
$md[] = "- `assets/examples/**` (includes normalized + PDF goldens; `pdf_sha256` recorded in the manifest)";
$md[] = "- `CONTRIBUTING.md`";
